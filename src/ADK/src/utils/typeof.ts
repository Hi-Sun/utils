...
function isBoolean(value: any): boolean {
  return value === true || value === false || (isObjectLike(value) && toObjectString(value) === '[object Boolean]');
}

function isNumber(value: any): boolean {
  return typeof value === 'number' || (isObjectLike(value) && toObjectString(value) === '[object Number]');
}
...
function isBigInt(value: any): boolean {
  ...
  return typeof value === 'bigint' || (isObjectLike(value) && toObjectString(value) === '[object BigInt]');
}

function isString(value: any): boolean {
  return typeof value === 'string' || (isObjectLike(value) && toObjectString(value) === '[object String]');
}

function isSymbol(value: any): boolean {
  return typeof value === 'symbol' || (isObjectLike(value) && toObjectString(value) === '[object Symbol]');
}
