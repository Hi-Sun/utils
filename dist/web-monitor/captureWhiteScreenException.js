...
var multiTry_js_1 = __importDefault(require("./multiTry.js"));
...
var doCapture = function () {
    return new Promise(function (resolve, reject) {
        if (hasCaptured) {
            ...
            reportSentry_1.default('client-side exception has occurred', {
                level: 'fatal',
            });
            hasCaptured = true;
            resolve(true);
...
var multiCapture = function () {
    multiTry_js_1.default(doCapture, 2, 50).catch(function () {
        // do nothing.
    });
};
